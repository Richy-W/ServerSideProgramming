...
<html lang="en">
    ...
    <body>
    <!-------------HEADER-------------->
        <header>CS2623 Richard Wren</header>
    <!--------------Nav----------------->
    <nav class="topNav">
            <ul>
                <li><a href="index.php">HOME</a></li>
                <li><a href="#">SSP02</a></li>
                <li><a href="#">SSP03</a></li>
                <li><a href="#">SSP04</a></li>
                <li><a href="#">SSP05</a></li>
        ...
        <main>
            <?php echo'Hello World (PHP Testing)';?>
        </main>

        <footer>
            Disclaimer: Oklahoma City Community College does not necessarily endorse he content or the respective links of this webpage.
        </footer>
